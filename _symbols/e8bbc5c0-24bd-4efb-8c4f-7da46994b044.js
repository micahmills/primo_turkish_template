// Navigation 1 - Updated November 13, 2024
function noop() { }
const identity = x => x;
...
// (146:8) {#each Object.entries(link) as lang_link }
function create_each_block_3(ctx) {
	let a;
	let t_value = /*lang_link*/ ctx[10][1].label + "";
	let t;
	let a_class_value;
	let a_href_value;
	...
	return {
		...
		h() {
			attr(a, "class", a_class_value = "link " + /*lang_link*/ ctx[10][0] + " svelte-1g2g4m0");
			attr(a, "href", a_href_value = /*lang_link*/ ctx[10][1].url);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 2 && t_value !== (t_value = /*lang_link*/ ctx[10][1].label + "")) set_data(t, t_value);

			if (dirty & /*site_nav*/ 2 && a_class_value !== (a_class_value = "link " + /*lang_link*/ ctx[10][0] + " svelte-1g2g4m0")) {
				attr(a, "class", a_class_value);
			}

			if (dirty & /*site_nav*/ 2 && a_href_value !== (a_href_value = /*lang_link*/ ctx[10][1].url)) {
...
// (145:6) {#each site_nav as link }
function create_each_block_2(ctx) {
	let each_1_anchor;
	let each_value_3 = Object.entries(/*link*/ ctx[7]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*Object, site_nav*/ 2) {
				each_value_3 = Object.entries(/*link*/ ctx[7]);
				let i;
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1g2g4m0");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1g2g4m0");
		},
		m(target, anchor) {
...
// (169:10) {#each Object.entries(link) as lang_link }
...
// (168:7) {#each site_nav as link }
function create_each_block(ctx) {
	let each_1_anchor;
	let each_value_1 = Object.entries(/*link*/ ctx[7]);
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*Object, site_nav*/ 2) {
				each_value_1 = Object.entries(/*link*/ ctx[7]);
				let i;
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1g2g4m0");
			attr(nav, "class", "svelte-1g2g4m0");
			attr(div0, "class", "desktop-nav svelte-1g2g4m0");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-1g2g4m0");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-1g2g4m0");
			attr(header, "class", "section-container svelte-1g2g4m0");
		},
		m(target, anchor) {
...
function showProperLanguageMenu() {
	let lang = document.documentElement.lang;
	const langLinks = document.querySelectorAll(`nav > .link.link_${lang}`);
